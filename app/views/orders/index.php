                        ...
                        <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                            <thead>
                                <tr role="row">
                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 229.537px;">
                                        ID</th>
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 379.19px;">ID người đặt</th>
                            ...
                            <tbody>
                                <?php while ($row = $orders->fetch(PDO::FETCH_ASSOC)) : ?>
                                    <tr class="even">
                                        <td class="sorting_1"><?= $row['order_id'] ?></td>
                                        <td><?= $row['account_id'] ?></td>
                                        <td><?= $row['total_amount'] ?></td>
                                      
                                        <td><?=$row['is_paid']? '<p class="text-success">Đã thanh toán':'<p class="text-danger">Chờ thanh toán</p>' ?></td>
