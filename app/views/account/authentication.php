	...
	<div class="main">  	
		...
		if (isset($errors)) {
			...
			foreach ($errors as $error) {
				echo "<li class='text-danger'style='color:chocolate'>". $error ."</li>";
			}
			echo "</ul>";
		}
if (isset($_GET['success'])) {
	if($_GET['success']){
		echo "
		<div class='alert alert-success' style='color:chartreuse'>
	  <strong>Success!</strong> Tạo tài khoản thành công
	</div>";
	}else{
		
			echo "
			<div class='alert alert-danger' style='color:chocolate'>
		  <strong>Success!</strong> Có lỗi xảy ra!
		</div>";
