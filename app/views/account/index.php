...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Dữ liệu Người dùng</h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <a href="/chieu2/account/login" class="btn btn-primary btn-icon-split">
                        ...
                        <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 169.306px;">Email</th>
                                ...
                                <?php while ($row = $users->fetch(PDO::FETCH_ASSOC)) : ?>
                                    <tr class="even">
                                        ...
                                        <td>
                                            ...
                                            <a href="/chieu2/account/edit/<?= $row['id'] ?>" class="text-primary">Edit</a> |
                                            <a href="/chieu2/account/delete/<?= $row['id'] ?>" class="text-danger">Delete</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
