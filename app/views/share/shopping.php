...
if (isset($_GET['success'])) {
  ...
  <strong>Success!</strong> Đặt hàng thành công, mã đơn hàng của bạn là COD".$_GET['success']."
</div>";
}
        ...
        <div class="table-responsive">
            <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div style="display:flex;justify-content: space-between;">
                    <a href="/chieu2/product/cart" class="btn btn-success btn-icon-split">
                            ...
                            <tbody>
                                <?php while ($row = $products->fetch(PDO::FETCH_ASSOC)) : ?>
                                    <tr class="even">
                                        ...
                                        <td><?= $row['price'] ?></td>
                                        <td>
                                            <form action="/chieu2/product/addtocart" method="post">
                                                <input type="hidden" name="product" value="<?= $row['id'] ?>">
                                                <button type="submit" name="add_to_cart" style="background-color: #5ed676;border-radius: 7px;">Thêm vào giỏ hàng</button>
                                            </form>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
